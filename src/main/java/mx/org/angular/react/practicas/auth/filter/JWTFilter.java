...
public class JWTFilter extends UsernamePasswordAuthenticationFilter{
	 ...
	 private AuthenticationManager authenticationManager;
	    ...
	    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
	        ...
	        try {
	            UsuarioEntity user = new ObjectMapper().readValue(request.getInputStream(), UsuarioEntity.class);
	    ...
	    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
	        ...
	        boolean isAdmin = roles.stream().anyMatch(role -> role.getAuthority().equals("ROLE_PUBLICADOR"));
	        Claims claims = Jwts
	                .claims()
	    ...
	    protected void unsuccessfulAuthentication(HttpServletRequest request, HttpServletResponse response,
	        ...
	        Map<String, String> body = new HashMap<>();
	        body.put("message", "Username o password incorrecto!");
